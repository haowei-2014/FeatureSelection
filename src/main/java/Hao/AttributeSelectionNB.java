 ...
 */
public class AttributeSelectionNB {
	...
	public static int nbGenerationGA = 2000;
	...
	// here specify a search algorithm
	public static int[] search(Instances data) throws Exception {	
//		 GreedyStepwise search = new GreedyStepwise();
//		 search.setSearchBackwards(false);
//		BestFirst search = new BestFirst();
//		search.setDirection(new SelectedTag(0, BestFirst.TAGS_SELECTION));
		 GeneticSearch search = new GeneticSearch();
		 search.setMaxGenerations(nbGenerationGA);
		 search.setReportFrequency(100);
//		 LinearForwardSelection search = new LinearForwardSelection();
//		 search.setForwardSelectionMethod(new SelectedTag(1, LinearForwardSelection.TAGS_SEARCH_METHOD));
	...
	public static void main(String[] args) throws Exception {
		// load data
		System.out.println("Use wrapper NaiveBayes. Greedystepwise backward selection.");	
...
//			nbGenerationGA = Integer.parseInt(args[1]);
		}

//		path = "E:\\HisDoc project\\FeatureSelectionForJournal\\datasets\\_arff\\LSVT\\";
		...
		System.out.println("\n Running time for feature selection: " + duration/ 1000000000 + " seconds");
//		crossValidation(data, indices, false);
		crossValidation(data, indices, true);
	}
}
