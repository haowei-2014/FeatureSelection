 ...
 */
public class FS_MLP_wrapper_CV {
	...
	protected static int[] wrapperFS(Instances data, boolean forward) throws Exception {
		AttributeSelection attsel = new AttributeSelection();
		ClassifierSubsetEval eval = new ClassifierSubsetEval();
...
//		System.out.println("selected attribute indices (starting with 0):\n" + Utils.arrayToString(indices));
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("GreedyStepwise");
		// System.out.println("\n0. Loading data");
		System.out.println(System.getProperty("user.dir"));
		String path = System.getProperty("user.dir") + File.separator + "mlp" + File.separator;
		boolean forward = true;
	//	String path = "E:\\Java2\\Weka\\mlp\\";
	//	String myFile = "splice_tmp.arff";
		String myFile = args[0];
		if (new String(args[1]).equals("true")){
			forward = true;
		...
		System.out.println("========================================");
		System.out.println(myFile + " is used.");
		DataSource source = new DataSource(path + myFile);
		Instances data = source.getDataSet();
		if (data.classIndex() == -1)
			data.setClassIndex(data.numAttributes() - 1);
		final long startTime1 = System.nanoTime();
		int[] indices = wrapperFS(data, forward);
